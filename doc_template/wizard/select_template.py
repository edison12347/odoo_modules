...
class WizardSelectMoveTemplate(models.TransientModel):
    ...
    def _get_default_template(self, vals, context):
        _logger.info('!!!!!!!!!!!!!!______contex_temp_________!!!!!!!!!!! %s', self._context.get('template_id'))
        _logger.info('!!!!!!!!!!!!!!______vals_________!!!!!!!!!!! %s', vals)
        _logger.info('!!!!!!!!!!!!!!______context_________!!!!!!!!!!! %s', context)
        return self._context.get('template_id')

    def _get_default_partner(self, cr, uid, context=None):
        res = self.pool.get('res.partner').search(cr, uid, [('id', '=', '3')], context=context)
        _logger.info('!!!!!!!!!!!!!!______context_________!!!!!!!!!!! %s', context)
        _logger.info('!!!!!!!!!!!!!!______res_________!!!!!!!!!!! %s', res)
        return res.id and res[0] or False
